package com.prolink.tiago.prolinkfranquias2018;
...
import com.prolink.tiago.prolinkfranquias2018.resources.ContatoRestClientUsage;
import com.prolink.tiago.prolinkfranquias2018.resources.FranquiasRestClientUsage;
import com.prolink.tiago.prolinkfranquias2018.resources.RegistroRestClientUsage;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void executarVerificacao(){
        ...
        if(!preferences1.contains(APP_COMERCIAL)){//setando comercial
            register(preferences1);
        }
        else if(preferences1.contains(APP_COMERCIAL)){//comercial ativo
            entity = CadastroActivity.class;
            comercialUse = " COMERCIAL :";
        }
        else{//setando franquia
